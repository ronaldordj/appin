      ...
      <div class="container-fluid">       
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            ?> 
              <a href="clientes_detalhes.php?key=<?php echo md5(microtime()); ?>&date=<?php echo base64_encode($row['Id'])?>&mic=<?php echo base64_encode($idvendedor)?>'" class="list-group-item">
                <?php echo $row['Id']." - ".$row['Razaosocial'];?>
              </a>
              <?php } ?>  
            </div>             
          </div>          
