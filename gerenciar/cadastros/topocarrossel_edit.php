<?php
	...
	//Executa consulta
	$sql="SELECT * FROM topo_carrossel WHERE Id = $id";
...
<body class="bg-dark">
  <div class="container">
    <div class="card card-register mx-auto mt-5">
      <div class="card-header">Imagem do Carrossel do Site</div>
      <div class="card-body">
		<form action="../processa/proc_edit_topocarrossel.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-row">
              <div class="col-xs-12 col-md6 col-lg-6">
                <div class="form-label-group">
                  ...
                  <label for="arquivo">Imagem Tamanho 1920x777</label>
                </div>
              </div>  
          </div>  
          <div class="form-group">
