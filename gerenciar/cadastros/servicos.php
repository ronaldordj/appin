...
<body class="bg-dark">
  <div class="container">
    <div class="card card-register mx-auto mt-5">
      <div class="card-header">Cadastro de Serviço</div>	
      <div class="card-body">
		<form action="../processa/proc_cad_servicos.php" method="post" enctype="multipart/form-data">		
            ...
            <div class="form-row">
              <div class="col-xs-12 col-md6 col-lg-6">
                <div class="form-label-group">
                  ...
                  <label for="arquivo">Imagem Tamnho 40x40</label>
                </div>
              </div>  
					  </div>  
          </div>            
