<?php
	...
	//Executa consulta
	$sql="SELECT * FROM inicial WHERE Id = $id";
...
<body class="bg-dark">
  <div class="container">
    <div class="card card-register mx-auto mt-5">
      <div class="card-header">Dados do cabeçalho da página Notícias</div>	
      <div class="card-body">
		<form action="../processa/proc_edit_noticiasintro.php" method="post" enctype="multipart/form-data">
