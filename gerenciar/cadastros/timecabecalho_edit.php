<?php
	...
	//Executa consulta
	$sql="SELECT * FROM time_cabecalho WHERE Id = $id";
...
<body class="bg-dark">
  <div class="container">
    <div class="card card-register mx-auto mt-5">
      <div class="card-header">Seção Nosso Time - Introdução</div>	
      <div class="card-body">
		<form action="../processa/proc_edit_timecabecalho.php" method="post">
