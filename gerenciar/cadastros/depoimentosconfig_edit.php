<?php
	...
	//Executa consulta
	$sql="SELECT * FROM depoimento_config WHERE Id = $id";
...
<body class="bg-dark">
  ...
  <div class="container">
    <div class="card card-register mx-auto mt-5">
      <div class="card-header">Configurar seção</div>
      <div class="card-body">
        <form action="../processa/proc_edit_depoimentosconfig.php" method="post">
          <input name="id" class="form-check-input" type="hidden" id="id" value="<?php echo $resultado['Id']; ?>">          	
