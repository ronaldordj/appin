<?php
	...
	//Executa consulta
	$sql="SELECT Id, Descricao, Ocultar FROM sobrenos_cabecalho WHERE Id = $id";
...
<body class="bg-dark">
  <div class="container">
    <div class="card card-register mx-auto mt-5">
      <div class="card-header">Sobre Nós - Introdução</div>	
      <div class="card-body">
		<form action="../processa/proc_edit_sobrenoscabecalho.php" method="post">
