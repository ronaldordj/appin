<?php
	...
	//Executa consulta
	$sql="SELECT Id, Descricao, Ocultar FROM sobrenos_historia WHERE Id = $id";
...
<body class="bg-dark">
  <div class="container">
    <div class="card card-register mx-auto mt-5">
      <div class="card-header">Sobre Nós - Nossa História</div>	
      <div class="card-body">
		<form action="../processa/proc_edit_sobrenoshistoria.php" method="post">
		<input type="hidden" id="id" name="id" value="<?php echo $id;?>">
          <div class="form-group">
            <div class="form-row">
              <div class="col-xs-12 col-md-12 col-lg-12">
                <div class="form-label-group">                  
                  <textarea name="descricao" id="descricao" class="form-control" placeholder="Descrição" required="required" maxlength="500"><?php echo $resultado['Descricao'];?></textarea>                  
