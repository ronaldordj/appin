...
<body class="bg-dark">
  <div class="container">
    <div class="card card-register mx-auto mt-5">
      ...
      <div class="card-body">
		<form action="../processa/proc_cad_depoimentos.php" method="post" enctype="multipart/form-data">		
          ...
          <div class="form-group">  
            <div class="form-row">  
              <div class="col-xs-12 col-md-12 col-lg-12">
                <div class="form-label-group">
                  <textarea name="depoimento" id="depoimento" class="form-control" placeholder="Depoimento" required="required"></textarea>                  
                </div>
              </div>			                
            </div>
          </div> 
