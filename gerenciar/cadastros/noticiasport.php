...
<body class="bg-dark">
  <div class="container">
    <div class="card card-register mx-auto mt-5">
      ...
      <div class="card-body">
		<form action="../processa/proc_cad_noticiasport.php" method="post" enctype="multipart/form-data">		
          <div class="form-group">
            <div class="form-row">
              <div class="col-xs-12 col-md-12 col-lg-12">
                <div class="form-label-group">
                  <input name="idnoticia" type="hidden" id="idnoticia" class="form-control" >
                  <input name="noticia" type="text" id="noticia" class="form-control" placeholder="Notícia" required="required" >
                  <label for="noticia">Digite as iniciais do título da Notícia</label>
                </div>
              </div>  
            </div>
          </div>  
