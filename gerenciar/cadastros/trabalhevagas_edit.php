<?php
	...
	//Executa consulta
	$sql="SELECT * FROM trabalhe_vagas WHERE Id = $id";
...
<body class="bg-dark">
  <div class="container">
    <div class="card card-register mx-auto mt-5">
      <div class="card-header">Editando dados da Vaga de Emprego</div>	
      <div class="card-body">
		<form action="../processa/proc_edit_trabalhevagas.php" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
          ...
          <div class="form-group">  
            <div class="form-row">  
              <div class="col-xs-12 col-md-12 col-lg-12">
                <div class="form-label-group">
                  <input name="pretensao" type="text" id="pretensao" class="form-control" placeholder="Pretensão Salarial" required="required"  value="<?php echo $resultado['Pretensao'] ?>" >
