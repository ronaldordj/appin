<?php
	...
	//Executa consulta
	$sql="SELECT Id, Descricao, Ocultar FROM extra_cabecalho WHERE Id = $id";
...
<body class="bg-dark">
  <div class="container">
    <div class="card card-register mx-auto mt-5">
      <div class="card-header">Seção Extra - Introdução</div>	
      <div class="card-body">
		<form action="../processa/proc_edit_extracabecalho.php" method="post">
