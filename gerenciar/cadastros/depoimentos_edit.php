...
<body class="bg-dark">
  <div class="container">
    <div class="card card-register mx-auto mt-5">
      <div class="card-header">Depoimentos - Mensagem</div>	
      <div class="card-body">
		<form action="../processa/proc_edit_depoimentos.php" method="post" enctype="multipart/form-data">
		<input type="hidden" id="id" name="id" value="<?php echo $id;?>">
          ...
          <div class="form-group">  
            <div class="form-row">  
              <div class="col-xs-12 col-md-12 col-lg-12">
                <div class="form-label-group">
                  <textarea name="depoimento" id="depoimento" class="form-control" placeholder="Depoimento" required="required"><?php echo $resultado['Depoimento'];?></textarea>                  
                </div>
              </div>			                
            </div>
          </div> 
