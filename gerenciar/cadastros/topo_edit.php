<?php
	...
	//Executa consulta
	$sql="SELECT * FROM topo_cabecalho WHERE Id = $id";
...
<body class="bg-dark">
  <div class="container">
    <div class="card card-register mx-auto mt-5">
      <div class="card-header">Topo - Introdução</div>	
      <div class="card-body">
		<form action="../processa/proc_edit_topo.php" method="post" enctype="multipart/form-data">
