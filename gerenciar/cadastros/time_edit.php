...
<body class="bg-dark">
  <div class="container">
    <div class="card card-register mx-auto mt-5">
      ...
      <div class="card-body">
		<form action="../processa/proc_edit_time.php" method="post" enctype="multipart/form-data">
          <input type="hidden" id="id" name="id" value="<?php echo $id;?>">		
          <div class="form-group">
            <div class="form-row">
              <div class="col-xs-12 col-md-12 col-lg-12">
                <div class="form-label-group">
                  <input name="pessoa" type="text" id="pessoa" class="form-control" placeholder="Pessoa" required="required" value="<?php echo $resultado['Pessoa'] ?>" >
          ...
          <div class="form-group">  
            <div class="form-row">  
              <div class="col-xs-12 col-md-12 col-lg-12">
                <div class="form-label-group">
                  <input name="cargo" type="text" id="cargo" class="form-control" placeholder="Cargo" required="required" value="<?php echo $resultado['Cargo'] ?>" >
          ...
          <div class="form-group">  
            <div class="form-row">  
              <div class="col-xs-12 col-md-12 col-lg-12">
                <div class="form-label-group">
                  <input name="whats" type="text" id="whats" class="form-control" placeholder="Whatsapp Ex: 48900000000" maxlength="11" value="<?php echo $resultado['Celular'] ?>" >
          ...
          <div class="form-group">  
            <div class="form-row">  
              <div class="col-xs-12 col-md-12 col-lg-12">
                <div class="form-label-group">
                  <input name="linkedin" type="text" id="linkedin" class="form-control" placeholder="Linkedin" value="<?php echo $resultado['Linkedin'] ?>" >
