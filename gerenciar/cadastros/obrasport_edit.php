<?php
  ...
  //Executa consulta
	$sql="SELECT op.Id, op.Idobra, op.Descricao, op.Imagem, op.Ocultar, o.Titulo
        FROM obras_portfolio op 
        JOIN obras o ON (o.Id = op.Idobra) 
        WHERE op.Id = $id";
...
<body class="bg-dark">
  <div class="container">
    <div class="card card-register mx-auto mt-5">
      ...
      <div class="card-body">
		<form action="../processa/proc_edit_obrasport.php" method="post" enctype="multipart/form-data">		
          <input type="hidden" id="id" name="id" value="<?php echo $id;?>">
          <div class="form-group">
            <div class="form-row">
              <div class="col-xs-12 col-md-12 col-lg-12">
                <div class="form-label-group">
                  <input name="idobra" type="hidden" id="idobra" class="form-control" value="<?php echo $resultado['Idobra']; ?>" >
                  <input name="obra" type="text" id="obra" class="form-control" placeholder="Obra" required="required" value="<?php echo $resultado['Titulo']; ?>">
