<?php	
	...
	$sql="select max(Id) as maior from clientes";
	$sql_result=mysqli_query($conexao,$sql)or die("Erro:".mysqli_error($conexao));
	$row=mysqli_fetch_array($sql_result);		
	$id = $row['maior']+1;	
	
	$queryInsercao = "INSERT INTO clientes (Id, Nome, Imagem, Ocultar) 
	...
	echo "<script>alert('Cliente cadastrado com sucesso!'),location.href='../listas/clientes.php'</script>";
